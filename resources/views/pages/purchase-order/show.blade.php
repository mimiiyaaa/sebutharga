...
<x-common.document-workspace :title="__('Butiran PO')" :reference="$order->po_no" x-data="{ loginInfoOpen: false }" @keydown.escape.window="loginInfoOpen = false">
    ...
    <div class="flex justify-end"><a href="{{ route('purchase-order.index') }}" class="inline-flex h-11 items-center justify-center rounded-lg border border-gray-300 bg-white px-4 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800">{{ __('Kembali') }}</a></div>
