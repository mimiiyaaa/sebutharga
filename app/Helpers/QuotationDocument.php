...
{
    public const FIELDS = ['issuer_name', 'issuer_phone', 'issuer_email', 'issuer_address', 'customer_name', 'company_name', 'phone_no', 'email', 'address', 'additional_terms', 'maklumat_tambahan', 'catatan', 'disediakan_role', 'diterima_role'];
